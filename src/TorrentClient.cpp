...
std::vector<std::string> const& defaultAdditionalTrackers() {
  static const std::vector<std::string> trackers{
      ...
      "udp://wc4sciqgkceddn6twerzkfod6p2npm733p7z3zwsjfzhc4yulita.b32.i2p:6969/",
...
lt::session_params makeSessionParams(ClientConfig const& config) {
  ...
  params.settings.set_bool(lt::settings_pack::allow_i2p_mixed, false);
  ...
  params.settings.set_str(lt::settings_pack::i2p_hostname,
                          config.libtorrent.i2p_hostname.value_or("127.0.0.1"));
  params.settings.set_int(lt::settings_pack::i2p_port,
                          config.libtorrent.i2p_port.value_or(7656));
  if (config.libtorrent.i2p_inbound_quantity) {
    params.settings.set_int(lt::settings_pack::i2p_inbound_quantity,
                            *config.libtorrent.i2p_inbound_quantity);
  }
  if (config.libtorrent.i2p_outbound_quantity) {
    params.settings.set_int(lt::settings_pack::i2p_outbound_quantity,
                            *config.libtorrent.i2p_outbound_quantity);
  }
  if (config.libtorrent.i2p_inbound_length) {
    params.settings.set_int(lt::settings_pack::i2p_inbound_length,
                            *config.libtorrent.i2p_inbound_length);
  }
  if (config.libtorrent.i2p_outbound_length) {
    params.settings.set_int(lt::settings_pack::i2p_outbound_length,
                            *config.libtorrent.i2p_outbound_length);
  }
  params.settings.set_int(lt::settings_pack::tracker_completion_timeout,
                          config.libtorrent.tracker_completion_timeout.value_or(120));
  params.settings.set_int(lt::settings_pack::tracker_receive_timeout,
                          config.libtorrent.tracker_receive_timeout.value_or(40));
  params.settings.set_int(lt::settings_pack::stop_tracker_timeout,
                          config.libtorrent.stop_tracker_timeout.value_or(10));
  params.settings.set_int(lt::settings_pack::peer_connect_timeout,
                          config.libtorrent.peer_connect_timeout.value_or(30));
  params.settings.set_int(lt::settings_pack::request_timeout,
                          config.libtorrent.request_timeout.value_or(120));
